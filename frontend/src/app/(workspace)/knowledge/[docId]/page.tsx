  ...
  if (isError || !doc) {
    return (
      <div className="p-8 text-red-500">
        ...
        <p>Failed to load document details. It may have been deleted.</p>
        <button
      ...
      <div className="overflow-hidden bg-white shadow sm:rounded-lg dark:bg-gray-800">
        ...
        <div className="px-4 py-5 sm:p-0">
          <dl className="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Embeddings</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0 dark:text-white">
                {doc.embedding_count}
              </dd>
            </div>
            ...
            {doc.preview && doc.preview.length > 0 && (
              <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Preview</dt>
